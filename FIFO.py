...
class FCFS:
    def running_time(self):
        print("Running Time for First In First Out :",time.time()-startTime)
    ...
    def statistics_FCFS_list(self):
        CPU_Usage = psutil.cpu_percent(2) / psutil.cpu_count()
        Memory_Usage = ((p1.memory_info().rss)/ 1024 ** 3)
        Virtual_Memory_Usage = psutil.virtual_memory()[2]
        io_counters = p1.io_counters()
